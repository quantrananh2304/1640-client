...
const AccountModal = loadable(
  () => import("~/components/molecules/SystemSetting/ModalAccount")
);
const ModalChangeDepartment = loadable(
  () => import("~/components/molecules/SystemSetting/ModalChangeDepartment")
);
...
const TableAccount = (props: Props) => {
  ...
  const [visibleModalChangeDepartment, setVisibleModalChangeDepartment] =
    useState(false);
  ...
  const columns: ColumnsType<any> = [
    ...
    },
    {
      ...
      render: (createdAt: string) => (
        <div>{createdAt && format(new Date(createdAt), DATE)}</div>
      ),
    },
    {
      title: "Email",
      ...
      >
        <div className={styles.headerConfirm}>
          ...
          <span className={styles.title}>
            Are you sure to INACTIVE this account?
          </span>
        </div>
      </Modal>
